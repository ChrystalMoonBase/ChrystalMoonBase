...
The bulldozer robot leads the construction team, preparing the regolith surface for sintering. Raw lunar regolith is too rough and too loosely compacted for high-quality sintering. The bulldozer clears rocks, grades the surface to a consistent level, and compacts the regolith — creating the prepared surface that the sintering robot needs.
