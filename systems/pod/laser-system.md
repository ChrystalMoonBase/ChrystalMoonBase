...
| Parameter | Value |
|---|---|
| Input electrical power | ~30 kW |
| Wall-plug efficiency | ~45% |
| Laser optical output | ~13.5 kW |
...
At 0.66 kW per robot, 8 robots simultaneously receive approximately 5.3 kW total. This is within the available laser output of 13.5 kW, suggesting headroom for either more robots, higher per-robot power, or losses higher than estimated. The actual operating point requires detailed modelling.
...
2. What fibre type and routing are required for the 100-metre mast interior, including the thermal cycling loads during deployment?
