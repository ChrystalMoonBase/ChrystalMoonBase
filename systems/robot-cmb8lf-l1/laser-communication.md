...
The round-trip communication delay to Earth is ~2.6 seconds (light-time ~1.3 s each way at the average Earth–Moon distance; varies slightly with orbital geometry, and in practice add processing/relay overhead). This delay means Earth cannot provide real-time control of any robot operation. All time-critical decisions are made autonomously by the robot AI or swarm coordinator. Earth provides strategic oversight, parameter updates, and responds to non-time-critical queries.
