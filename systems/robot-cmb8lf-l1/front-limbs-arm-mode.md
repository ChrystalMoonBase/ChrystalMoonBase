...
**Leg mode (default):** The front limbs function identically to the four other legs. The robot walks on all eight legs. The front limbs' end-effectors (feet) contact the ground normally.
