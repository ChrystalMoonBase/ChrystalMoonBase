...
| Could the blade be used to lightly shape semi-molten regolith? | If the cutting edge were a tungsten alloy (melting point >3400°C vs. molten regolith ~1,200 C basalt-ref / ~1,550 C anorthosite), could the blade smooth a freshly sintered surface before it fully cools? Would hot material stick? A question for materials scientists. |
