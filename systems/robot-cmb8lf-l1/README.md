...
In vacuum there is no convective cooling. Molten regolith in lunar vacuum cools significantly slower than on Earth, giving the forming tip time to work. At forming temperature its viscosity is comparable to thick syrup — a few newtons of steady pressure is enough to shape it. (Viscosity/temperature figures here are basalt-referenced; see the feedstock note below.)
...
|---|---|---|
| Melting point | above 3000C | Safe margin over molten regolith (~1,200 C basalt-ref / ~1,550 C anorthosite) |
...
| Surface coating | HfC melting point 3958C | Reduces molten-regolith adhesion to the tip |
...
|---|---|
| Does molten regolith (anorthosite) adhere to HfC-coated W-Re? | Core feasibility of the forming tip |
...
| Molten regolith cooling rate in lunar vacuum | Determines working window for the forming tip |
